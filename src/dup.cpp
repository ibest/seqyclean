...
void screen_duplicates(Read *seq1, Read *seq2, long long &duplicates) {
    int c = 0;
...
void screen_duplicates(Read *seq1, long long &duplicates) {
    int c = 0;
    
    if( (seq1->initial_length < start_dw+size_dw) ) return;
    
    string comb = seq1->read.substr(start_dw,size_dw);
